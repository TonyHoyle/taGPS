...
class GpsData {
  ...
  void _updateLocation(LocationData currentLocation)
  {
    ...
    // different results, plus there's the pythagorean approximation..
    const earthRadius = 6378137.0;
    final dLat = sin(lat2 - lat1) / 2;
    final dLon = sin(lon2 - lon1) / 2;
    final a = (dLat*dLat) * (dLon*dLon) + cos(lat1) * cos(lat2);
    final flatDistance = 2000 * earthRadius * atan2(sqrt(a), sqrt(1-a));
